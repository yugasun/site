...
var MetisMenu = (function(_React$Component) {
  ...
  function MetisMenu(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (MetisMenu.__proto__ || Object.getPrototypeOf(MetisMenu)).call(
        this,
        props
      )
    )
    ...
    if (props.onSelected) {
      _this.store.dispatch(
        (0, _emitters.updateListener)(_this.reduxUid, props.onSelected)
      )
    }
  ...
  _createClass(MetisMenu, [
    ...
    },
    {
      ...
      value: function changeActiveLinkId(value) {
        this.store.dispatch(
          (0, _content.changeActiveLinkId)(this.reduxUid, value)
        )
      },
    },
    {
      ...
      value: function changeActiveLinkTo(value) {
        this.store.dispatch(
          (0, _content.changeActiveLinkTo)(this.reduxUid, value)
        )
      },
    },
    {
      ...
      value: function changeActiveLinkLabel(value) {
        this.store.dispatch(
          (0, _content.changeActiveLinkLabel)(this.reduxUid, value)
        )
      },
    },
    {
      ...
      value: function changeActiveLinkFromLocation() {
        this.store.dispatch(
          (0, _content.changeActiveLinkFromLocation)(this.reduxUid)
        )
      },
    },
    {
      ...
      value: function updateActiveLink(props) {
        ...
        else if (props.activeLinkFromLocation)
          this.changeActiveLinkFromLocation()
      },
    },
    {
      ...
      value: function updateRemoteContent(props) {
        ...
        ajax.on('success', function(event) {
          ...
          try {
            ...
            throw new Error(
              'MetisMenu: Ajax response expected to be json, but got; ' +
                responseText
            )
          }
...
MetisMenu.propTypes = {
  ...
  ajax: _propTypes2.default.oneOfType([
  ...
  classNameContainer: _propTypes2.default.oneOfType([
    _propTypes2.default.func,
    _propTypes2.default.string,
  ]),
  ...
  activeLinkId: _propTypes2.default.oneOfType([
