...
import { Container, Box, Flex, Image, Row, Logo, Heading } from 'serverless-design-system'
...
class index extends Component {
    ...
    render() {
        return (
            ...
            {
                this.props.includeDesktop ? <SubscribeOptionDesktop onClick={this.handleModalOpen}/> : null
            }
