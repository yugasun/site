...
const ourValuesContent = [
  ...
  { header: 'Future minded creativity', content: 'We make forward-thinking decisions for the long-term, not based on what others are doing right now. We identify root causes instead of treating symptoms.' },
