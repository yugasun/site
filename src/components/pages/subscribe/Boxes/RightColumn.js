...
import cronicleLogo from 'src/assets/images/pages/subscribe/cronicle-logo.svg'
    ...
    >
      <Overflow o='hidden' width={1} px={[0, 0, 6]} pb={[0, 0, 92]}>
        <Box mb={[42, 42, 62, 62, 92]} mt={[62, 62, 92]}>
          <Image src={cronicleLogo} height={31} width={300} />
        </Box>
        <Box width={[0.9, 0.9, 0.85]}>
          <P mt={0} pb={[0, 0, 2]}>
            A weekly digest of the best serverless writing and projects from all
            over the web. Walk throughs, hot takes, GitHub repos, and more.
          </P>
          <NewsLetterForm
            emailFieldProps={{
              width: 1,
