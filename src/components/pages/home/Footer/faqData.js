export default [
  {
    ...
    answer: `Just like wireless internet has wires somewhere, serverless architectures still have servers somewhere. What ‘serverless’ really means is that, as a developer you don’t have to think about those servers. You just focus on code. 
  ...
  },
  {
    ...
    answer: `1. Great developer experience. We’re a developer tools company, not an infrastructure company, and that means we put developer experience before all else. Developers love using our tools because they give them superpowers.
