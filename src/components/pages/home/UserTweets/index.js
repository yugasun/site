    ...
    return (
      <div className='container user-tweets-component'>
        <div className='container-inner user-tweets-inner'>
          <div className='container header-label'>Serverless Architects</div>
          ...
          <div className='container user-tweets-tweets'>
            ...
            <div className='user-tweets-tweet'>
              ...
              <div className='user-tweets-tweet-text'>
                I’m still a huge fan of @Docker but man this @goserverless stuff
                is purely amazing, I'm fully onboard with managing
            ...
            <div className='user-tweets-tweet'>
              ...
              <div className='user-tweets-tweet-text'>
                Built two #Lambda functions today via @goserverless. One runs
                daily to update all of our coupons in DynamoDB. And the other is
                the query function to search DynamoDB for the coupon. Super
                duper easy with Serverless framework. Got it live and almost in
                prod already.
              </div>
            </div>
          </div>
          ...
          <div className='user-tweets-actions container'>
            <span>
            Serverless Architects are a new and fast growing role</span>
            <span >&nbsp;-{' '}</span>
            <InternalLink to={learn}>
              <span>Learn how to build Serverless Applications here</span>
            </InternalLink>
          </div>
        </div>
      </div>
