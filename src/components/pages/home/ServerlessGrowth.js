  ...
  <AppContainer>
    ...
    >
      <Column width={[1, 1, 1 / 2, '488px']} pt={[33, 33, 0, 107, 100, 180]}>
        ...
        <P pb={['16px', '16px', '24px']} mt={['8px', '8px', 0]}>
          Serverless developers don’t just leverage FaaS. They build servicefull
          applications that stitch together SaaS, hosted services and compute.
        </P>
        <InternalLink to='/learn/overview/' className='position-content'>
          <Button>learn more</Button>
        </InternalLink>
      </Column>
      <MobileCenteredBox>
        <Image
          src={usingSafariDesktop ? riseOfServerlessStatic : riseOfServerless}
          width={[300, 300, 300, 400, 450, 550]}
        />
      </MobileCenteredBox>
    </ResponsiveStack.spaceBetween>
  </AppContainer>
