            ...
            <div className='hero-video-content'>
              ...
              { this.state.chapter === 'develop' && (
                <video autoPlay muted onEnded={() => { this.toggleChapter('deploy') }}>
                  <source src='https://s3-us-west-2.amazonaws.com/assets.site.serverless.com/home/lifecycle_develop_2_3.mp4' type='video/mp4' />
                </video>
              )}

              { this.state.chapter === 'deploy' && (
                <video autoPlay muted onEnded={() => { this.toggleChapter('monitor') }}>
                  <source src='https://s3-us-west-2.amazonaws.com/assets.site.serverless.com/home/lifecycle_deploy_2_2.mp4' type='video/mp4' />
                </video>
              )}

              { this.state.chapter === 'monitor' && (
                <video autoPlay muted onEnded={() => { this.toggleChapter('intro') }}>
                  <source src='https://s3-us-west-2.amazonaws.com/assets.site.serverless.com/home/lifecycle_monitor_2_4.mp4' type='video/mp4' />
                </video>
              )}
