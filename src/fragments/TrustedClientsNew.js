...
const TrustedClients = () => (
  <Background backgroundImage={[`url(${backgroundImage})`]} height={['700px', '700px', '619px']}>
    <AppContainer>
      ...
      mb={8}
    >
    <Box mr={['20px', '20px', '20px', '20px', '0px']} ml={[0, 0, '50px', '50px', '100px']}>
      <Image src={eaLogo} width={['54px', '54px', '54px', '54px', '72px', '90px']} height={['26px', '26px', '26px', '26px', '44px']} />
    </Box>
    ...
    <Box mt={['20px', '20px', '0px']} mr={[0, 0, '50px', '50px', '100px']}>
